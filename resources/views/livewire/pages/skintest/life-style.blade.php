<div class="container pb-5">
  <section style="margin-bottom: 150px;">
    <div class="question text-center mt-5 mb-3">
      <h1 class="fw-bold">Dalam sebulan terakhir, seberapa sering kamu menggunakan retinol?</h1>
      <p>Contoh seperti retinol, adapalene, retynyl palmitate</p>
    </div>
    <form action="#">
          ...
          <div class="row d-flex justify-content-between">
            <div class="col-md-4">
              <a href="#question-8" class="d-blok text-decoration-none">
                ...
                <h6 class="text-center text-dark fw-bold mt-3">Jarang</h6>
              </a>
            </div>
            <div class="col-md-4">
              <a href="#question-8" class="d-blok text-decoration-none">
                ...
                <h6 class="text-center text-dark fw-bold mt-3">Tidak Pernah</h6>
              </a>
            </div>
            <div class="col-md-4">
              <a href="#question-8" class="d-blok text-decoration-none">
                ...
                <h6 class="text-center text-dark fw-bold mt-3">Sering</h6>
              </a>
            </div>
          </div>
        </div>
          ...
          <div class="row d-flex justify-content-between">
            <div class="col-md-2">
              <a href="#question-10" class="d-blok text-decoration-none">
                ...
                <h6 class="text-center text-dark fw-bold mt-3">Kurang dari 1 jam</h6>
              </a>
            </div>
            <div class="col-md-2">
              <a href="#question-10" class="d-blok text-decoration-none">
                ...
                <h6 class="text-center text-dark fw-bold mt-3">1-3 jam</h6>
              </a>
            </div>
            <div class="col-md-2">
              <a href="#question-10" class="d-blok text-decoration-none">
                ...
                <h6 class="text-center text-dark fw-bold mt-3">4-6 jam</h6>
              </a>
            </div>
            <div class="col-md-2">
              <a href="#question-10" class="d-blok text-decoration-none">
                ...
                <h6 class="text-center text-dark fw-bold mt-3">7-8 jam</h6>
              </a>
            </div>
            <div class="col-md-2">
              <a href="#question-10" class="d-blok text-decoration-none">
                ...
                <h6 class="text-center text-dark fw-bold mt-3">Lebih dari 8 jam</h6>
              </a>
            </div>
          ...
          <div class="row d-flex justify-content-between">
            <div class="col-md-3">
              <a href="#question-11" class="d-blok text-decoration-none">
                ...
                <h6 class="text-center text-dark fw-bold mt-3">Antara jam 9 dan 11 malam</h6>
              </a>
            </div>
            <div class="col-md-3">
              <a href="#question-11" class="d-blok text-decoration-none">
                ...
                <h6 class="text-center text-dark fw-bold mt-3">Antara jam 11 malam dan 1 pagi</h6>
              </a>
            </div>
            <div class="col-md-3">
              <a href="#question-11" class="d-blok text-decoration-none">
                ...
                <h6 class="text-center text-dark fw-bold mt-3">Antara jam 1 dan 3 pagi</h6>
              </a>
            </div>
            <div class="col-md-3">
              <a href="#question-11" class="d-blok text-decoration-none">
                ...
                <h6 class="text-center text-dark fw-bold mt-3">Setelah jam 3 pagi</h6>
              </a>
            </div>
          </div>
        </div>
          ...
          <div class="row d-flex justify-content-between">
            <div class="col-md-2">
              <a href="#question-12" class="d-blok text-decoration-none">
                ...
                <h6 class="text-center text-dark fw-bold mt-3">Sepeda motor</h6>
              </a>
            </div>
            <div class="col-md-2">
              <a href="#question-12" class="d-blok text-decoration-none">
                ...
                <h6 class="text-center text-dark fw-bold mt-3">Mobil</h6>
              </a>
            </div>
            <div class="col-md-2">
              <a href="#question-12" class="d-blok text-decoration-none">
                ...
                <h6 class="text-center text-dark fw-bold mt-3">Bus umum</h6>
              </a>
            </div>
            <div class="col-md-2">
              <a href="#question-12" class="d-blok text-decoration-none">
                ...
                <h6 class="text-center text-dark fw-bold mt-3">Kereta</h6>
              </a>
            </div>
            <div class="col-md-2">
              <a href="#question-12" class="d-blok text-decoration-none">
                ...
                <h6 class="text-center text-dark fw-bold mt-3">Jalan kaki</h6>
              </a>
            </div>
            <div class="col-md-2">
              <a href="/skintest/Do-you-have-a-special-diet" wire:navigate class="d-blok text-decoration-none">
                <div class="card dark-cream-bg rounded-4 overflow-hidden border-0" style="height: 157px;">
                  <div class="card-body p-4">
                    <img src="/mov-assets/go-6.png" alt="" width="100%">
                  </div>
                </div>
                <h6 class="text-center text-dark fw-bold mt-3">Aku jarang berpergian </h6>
              </a>
            </div>
          </div>
        </div>
  ...
  <section style="margin-bottom: 100px;" id="question-12">
    ...
    <p class="text-center my-4">Beri tahu kami apa yang Anda berikan pada diri Anda, sehingga kami tahu apa yang harus
      diberikan
      pada kulit Anda.
    </p>
    <form>
