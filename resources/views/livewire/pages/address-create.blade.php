      ...
      <div class="col-md-9">
        <div>
          <div class="bg-light p-4 rounded-4">
            <header class="mb-5">
              <h4 class="text-uppercase fw-bold">Tambah Alamat</h4>
            </header>
            ...
            <form wire:submit.prevent='addAddress'>
              ...
              <div class="mb-3">
                ...
                <input type="text" wire:model='name' id="name" name="name" value="{{ Auth::user()->name }}"
                  class="form-control">
                @error('name')
              ...
              <div>
                <button type="submit" class="btn dark-cream-bg text-white">Tambah</button>
              </div>
            </form>
          </div>
        </div>
